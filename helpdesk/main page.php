...
<tr>
	...
	?>
	<td style="background:url('body background1.jpg') no-repeat;  background-size: 100%; background-position: center; background-color: #66ceae;" width="85%" rowspan=2 valign="top"  style="background-color:#66ceae; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color:black;" bordercolor="#FF6600">
