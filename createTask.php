...
if((isset($_POST['client_name']))&&($_POST['client_name']!=="")){
	...
	$db=retrieveHelpdeskDb("secondary");
	...
	$sql="insert into forward_task(id,client_name,division_id,unit_id,classification_id,dispatch_time,problem_details) values ('".$taskID."',\"".$_POST['client_name']."\",'".$_POST['office_name']."','".$_POST['unit_type']."','".$_POST['problem_concern']."','".$received_date."',\"".$_POST['details']."\")";
	$rs=$db->query($sql);


	echo "Thank you for your inquiry!  We will look into your problem as soon as possible.<br>";
*/
...
<div align=center><img src="helpdesk Header.jpg" style="width:75%; height:250;" /></div>
<!--
