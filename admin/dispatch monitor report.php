			...
			<div class="row-fluid">		
				<div class="box span12">
					<div class="box-header" data-original-title="">
						<h2><i class="icon-tasks"></i><span class="break"></span>Dispatcher Update List</h2>
						<div class="box-icon">
...
<br>
	...
	?>
		<div class="modal hide fade" id="datafilterModal">
			...
			<form class="form-horizontal" id='checkForm' name='checkForm' action='dispatch monitor report.php' method='post'/>
