...
if(isset($_SESSION['sql_printout'])){
	...
	$conditionClause=$_SESSION['print_condition'];
	echo $routingHeading;
?>
<br>
	<table border=1 id='cssTable' width=100% >
	<tr>
	<th colspan=6><h2>Equipment Statistics Report</h2></th>
	</tr>
	...
	<div align=center><a href='print_outline5.php?print=1'>Generate Print Out</a></div>
	<?php
	if(isset($_GET['print'])){
		...
		$folder="c:/report/";
		$workbookname="Equipment Statistics Report - Generated ";
		...
		$workSheetName="Equipment Stats Report";		
	...
	//addContent($range,$excelAPI,$content,$merged,$excelWorksheet)
		addContent($rr,$excel,"Equipment Statistics Report","true",$ExWs);
//		setCellArea($rr,$excel,$ExWs,$excel);
		...
		if($nm>0){
			...
			$rr[1]="D".$i;
			setHeadingArea("minor",$rr,"true",$excel,$ExWs);
			addContent($rr,$excel,"Property No.","true",$ExWs);
			setCellArea($rr,$excel,$ExWs,$excel);
			styleCellArea(setRange($rr[0],$rr[1]),"true","true",$ExWs,$excel);
			...
			$rr[1]="H".$i;
			setHeadingArea("minor",$rr,"true",$excel,$ExWs);
			addContent($rr,$excel,"Action Taken","true",$ExWs);
			setCellArea($rr,$excel,$ExWs,$excel);
			styleCellArea(setRange($rr[0],$rr[1]),"true","true",$ExWs,$excel);
			...
			$rr[1]="J".$i;
			setHeadingArea("minor",$rr,"true",$excel,$ExWs);
			addContent($rr,$excel,"Recommendation","true",$ExWs);
			setCellArea($rr,$excel,$ExWs,$excel);
			styleCellArea(setRange($rr[0],$rr[1]),"true","true",$ExWs,$excel);
			...
			$rr[1]="L".$i;
			setHeadingArea("minor",$rr,"true",$excel,$ExWs);
			addContent($rr,$excel,"Frequency","true",$ExWs);
			setCellArea($rr,$excel,$ExWs,$excel);
			styleCellArea(setRange($rr[0],$rr[1]),"true","true",$ExWs,$excel);
			...
			for($m=0;$m<$nm;$m++){
				...
				$rr[0]="c".$i;
				$rr[1]="d".$i;
				addContent($rr,$excel,$row['property_no'],"true",$ExWs);
				setCellArea($rr,$excel,$ExWs,$excel);
				styleCellArea(setRange($rr[0],$rr[1]),"false","true",$ExWs,$excel);

				$rr[0]="e".$i;
				$rr[1]="f".$i;
				addContent($rr,$excel,$row['problem_details'],"true",$ExWs);
				setCellArea($rr,$excel,$ExWs,$excel);
				styleCellArea(setRange($rr[0],$rr[1]),"false","true",$ExWs,$excel);
				
				$rr[0]="g".$i;
				$rr[1]="h".$i;
				addContent($rr,$excel,$row3['action_taken'],"true",$ExWs);
				setCellArea($rr,$excel,$ExWs,$excel);
				styleCellArea(setRange($rr[0],$rr[1]),"false","true",$ExWs,$excel);

				$rr[0]="i".$i;
				$rr[1]="j".$i;
				addContent($rr,$excel,$row3['recommendation'],"true",$ExWs);
				setCellArea($rr,$excel,$ExWs,$excel);
				styleCellArea(setRange($rr[0],$rr[1]),"false","true",$ExWs,$excel);

				if($row4['property_count']>6){
				$frequency=$row4['property_count']." (For replacement)";
				}
				else {
					$frequency=$row4['property_count'];
